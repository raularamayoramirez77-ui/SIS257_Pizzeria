import { IsDateString, IsDefined, IsNotEmpty, IsString, Max, MaxLength } from "class-validator";
...
export class CreateEmpleadoDto {
    ...
    @MaxLength(20,{message:'El campo del segundo apellido debe tener maximo 20 caracteres'})  
    readonly egundoApellido: string;

    @IsNotEmpty({message:'El campo dirección es obligatorio'})
    @IsString({message:'El campo dirección debe ser tipo cadena'})
    @MaxLength(100,{message:'El campo dirección debe tener maximo 100 caracteres'})  
    readonly direccion: string;

    @IsNotEmpty({message:'El campo celular es obligatorio'})
    @IsString({message:'El campo celular debe ser tipo cadena'})
    @MaxLength(15,{message:'El campo celular debe tener maximo 15 caracteres'})  
    ...
    @IsString({message:'El campo usuario registro debe ser tipo cadena'})
    ...
    @IsDateString({},{message:'El campo fecha registro debe ser tipo fecha'})
